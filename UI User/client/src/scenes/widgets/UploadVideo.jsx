...
import { Box, useTheme, Button, TextField, Typography, Paper, IconButton } from "@mui/material";
...
const UploadVideo = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/VideoHome'); // Redirect after success
    } catch (error) {
      setMessage("Failed to post the service");
      toast.error("Failed to post the service");
    }
  };
