...
const FeedbackForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const userId = '12345';  // Replace with actual userId fetching logic
      const feedbackData = new FormData();
      feedbackData.append('area', formData.area);
      feedbackData.append('details', formData.details);
      feedbackData.append('userId', userId);
      if (formData.file) {
        feedbackData.append('file', formData.file);  // Append the file to the form data
      }
